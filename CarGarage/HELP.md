...
* The original package name '2022a.iob.Podcast' is invalid and this project uses 'a.iob.Podcast' instead.
...
```
$ docker run --rm -p 8080:8080 Podcast:0.0.1-SNAPSHOT
```
